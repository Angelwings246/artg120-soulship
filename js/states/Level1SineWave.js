...
'use strict';
var timer;
var Level1SineWave = function(game) {
	    this.bmd = null;
        this.enemy = null;
        this.mode = 0;
...
Level1SineWave.prototype = {
    ...
    this.timer.loop(game.rnd.integerInRange(500,2000), this.fire, this);
    if (this.timer >= 1000 && this.timer <= 4000){
    	this.timer.loop(400, this.spawnSineA, this);
    }
    if (this.timer > 4000 && this.timer <= 10000){
    	this.timer.loop(400, this.spawnSineA, this); 
    } 
